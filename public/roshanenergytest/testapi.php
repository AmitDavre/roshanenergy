...
#afterpay-button {
  height: 40px;
    ...
    ></script>
    <script>
      const appId = 'sandbox-sq0idb-yXNgNEmSwFfjKv9Nnfnz1w';
      const locationId = 'LKNYD0HWCBEZV';
      ...
      async function createPayment(token, verificationToken) {
        ...
        const paymentResponse = await fetch('https://sandbox.web.squarecdn.com/payment', {
          method: 'POST',
          headers: {
